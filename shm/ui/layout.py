...
#     - Fullscreen CPU / DISK / NETWORK
#     """

#     focused_panel = reactive(None)  # None | "cpu" | "disk" | "network"
...
#             cpu_full.display = True
#             disk_full.display = False
#             net_full.display = False

#         elif value == "disk":
#             dashboard.display = False
#             disk_full.display = True
#             cpu_full.display = False
#             net_full.display = False

#         elif value == "network":
#             dashboard.display = False
#             net_full.display = True
#             cpu_full.display = False
#             disk_full.display = False
